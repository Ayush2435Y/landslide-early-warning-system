...
export const TopNavbar: React.FC<TopNavbarProps> = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full z-50 flex justify-between items-center px-4 md:px-6 h-16 bg-[#0a1128] border-b border-slate-800 text-white select-none shadow-md">
